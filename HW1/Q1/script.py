...
for page in range(18):
    page = page + 1
    api_link_drama='https://api.themoviedb.org/3/discover/movie?api_key={}&sort_by=popularity.desc&page={}&primary_release_date.gte=2004-01-01&with_genres=18'.format(api_key,page)
    ...
    for movie in drama_movie_list:
        ...
        if count <= 350: f1.write(drama_csv_string)
        if count%39 ==0: time.sleep(10)
